...
n = 1000
pd.plotting.scatter_matrix(df.sample(n), alpha=0.2, diagonal='hist')
plt.title('EDA Sample of ' + str(n))
plt.show()
...
df.groupby('Gender').Age.plot(legend=True, title='Gender vs Age', grid=True)
plt.show()
